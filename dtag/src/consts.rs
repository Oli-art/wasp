...
pub const FUNC_CREATE_ROUND:        &str = "createRound";
pub const FUNC_END_ROUND:           &str = "endRound";
...
pub const HFUNC_CREATE_ROUND:        ScHname = ScHname(0xcdce9137);
pub const HFUNC_END_ROUND:           ScHname = ScHname(0xff67e12f);
